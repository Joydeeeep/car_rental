 ...
 * @author joyde
 */
public class DelV extends javax.swing.JFrame {

    /**
     * Creates new form DelV
     */
    public DelV() {
        initComponents();
    }
    ...
    private void jButton2MousePressed(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_jButton2MousePressed
        try{
            ...
            Conn c = new Conn();
            String sql = "delete from vehicle value where V_NO = "+s1;
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(DelV.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
