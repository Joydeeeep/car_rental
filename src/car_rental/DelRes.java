 ...
 * @author joyde
 */
public class DelRes extends javax.swing.JFrame {

    /**
     * Creates new form DelRes
     */
    public DelRes() {
        initComponents();
    }
    ...
    private void jButton2MousePressed(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_jButton2MousePressed
        try{
            ...
            Conn c = new Conn();
            String sql = "delete from reservation value where R_ID = "+s1;
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(DelRes.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
